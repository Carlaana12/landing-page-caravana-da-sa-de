/*
  ...
  1. Changes
    ...
    - Create functions for adding initial users
    - Execute functions to create users
    - Drop functions after use (cleanup)
...
BEGIN
  ...
  VALUES (
    ...
    crypt('Admin@2025', gen_salt('bf')), -- This creates a secure password hash
    NOW(),
...
BEGIN
  ...
  VALUES (
    ...
    crypt('Parceiro@2025', gen_salt('bf')), -- This creates a secure password hash
    NOW(),
    '{"provider":"email","providers":["email"]}',
    '{"name":"Parceiro"}'
  )
